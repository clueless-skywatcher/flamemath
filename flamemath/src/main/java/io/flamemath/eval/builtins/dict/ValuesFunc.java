...
public class ValuesFunc implements FlameFunction {
    ...
    public Expr apply(List<Expr> args, FlameValuator evaluator) throws Exception {
        ...
        if (args.get(0) instanceof DictExpr d) {
            return new ListExpr(new ArrayList<>(d.dict().values()));
        }
        throw new Exception("Values expects a Dict, got " + args.get(0).head());
    }
}
